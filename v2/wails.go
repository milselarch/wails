...
import (
	_ "github.com/milselarch/wails/v2/internal/goversion" // Add Compile-Time version check for minimum go version
	"github.com/milselarch/wails/v2/pkg/application"
