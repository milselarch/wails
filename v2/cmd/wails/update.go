...
func updateToVersion(targetVersion *github.SemanticVersion, force bool, currentVersion string) error {
	...
	sout, serr, err := shell.RunCommand(homeDir, "go", "install", "github.com/milselarch/wails/v2/cmd/wails@"+desiredVersion)
	if err != nil {
	...
	pterm.Println(color.Green("  require github.com/milselarch/wails/v2 " + desiredVersion))
