...
Des guides ont été créés dans leurs propres sections. Avant de commencer, veuillez vous présenter dans la discussion [Contribuer à Wails](https://github.com/milselarch/wails/discussions/1520).
...
Si vous avez besoin de plus de clarté ou d'aide lors des tests, veuillez poser une question dans la discussion [Contribuer à Wails](https://github.com/milselarch/wails/discussions/1520) ou sur slack.
...
Si vous souhaitez ajouter une nouvelle langue à la documentation, veuillez suivre les instructions pour [remplir et soumettre un problème](https://github.com/milselarch/wails/issues/new?assignees=&labels=documentation&template=documentation.yml). Après avoir été approuvé par le mainteneur, nous ajouterons la langue dans « crowdin » et vous pourrez ensuite soumettre votre traduction.
