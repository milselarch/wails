...
See [issue 3240](https://github.com/milselarch/wails/issues/3240) for details
...
Default (Linux): Due to [#2977](https://github.com/milselarch/wails/issues/2977,), if `options.Linux` is nil
